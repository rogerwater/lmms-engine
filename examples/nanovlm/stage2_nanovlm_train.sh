#!/bin/bash
DATASET_PATH="/path/to/satge2_llava_next.yaml"
PROCESSOR_NAME="./output/nanovlm_stage1/checkpoint-2180-merged"
MODEL_PATH="./output/nanovlm_stage1/checkpoint-2180-merged"
...
NUM_TRAIN_EPOCHS=1
RUN_NAME="nanovlm_stage2"
OUTPUT_DIR="./output/nanovlm_stage2"
WARMUP_RATIO=0.03
MAX_STEPS=11540 #738519/8/8 
...
torchrun --nproc_per_node="8" \
    ...
    dataset_config.packing_length=32768 \
