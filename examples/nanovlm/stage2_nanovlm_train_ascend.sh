...
DATASET_PATH="${DATASET_PATH:-/home/ma-user/work/dataset/Data_NanoVLM/stage2_llava_next.yaml}"
PROCESSOR_NAME="${PROCESSOR_NAME:-/home/ma-user/work/output/nanovlm_stage1_ascend/checkpoint-2180-merged}"
MODEL_PATH="${MODEL_PATH:-/home/ma-user/work/output/nanovlm_stage1_ascend/checkpoint-2180-merged}"
...
USE_NPU_RMS_NORM="${USE_NPU_RMS_NORM:-false}"
USE_NPU_ROPE="${USE_NPU_ROPE:-false}"
USE_NPU_CROSS_ENTROPY="${USE_NPU_CROSS_ENTROPY:-false}"
...
if [[ "${USE_NPU_CROSS_ENTROPY}" == "true" ]]; then
  MODEL_PATCH_TYPES+=("npu_cross_entropy")
fi
...
MAX_STEPS="${MAX_STEPS:-11540}"
WARMUP_RATIO="${WARMUP_RATIO:-0.03}"

PACKING_LENGTH="${PACKING_LENGTH:-32768}"
...
RUN_NAME="${RUN_NAME:-nanovlm_stage2_ascend}"
OUTPUT_DIR="${OUTPUT_DIR:-/home/ma-user/work/output/nanovlm_stage2_ascend}"
